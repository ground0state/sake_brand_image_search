...
knn = FaissKNeighbors(join(save_dir, "merged.index"), k=20)
...
submission.to_csv(join(save_dir, f"merged_submission.csv"), index=False)
logger.info(f"submission shape: {submission.shape}")
df_test.to_csv(join(save_dir, f"merged_df_test.csv"), index=False)
