...
logger = setup_logger(str(C.work_dir.joinpath("history.log")))
logger.info("Test start.")

# アノテーション読み込み
df_cite = pd.read_csv(C.cite_filepath)
# df_train = pd.read_csv(C.train_filepath)
...
# df_train["path"] = [str(C.query_images_dir.joinpath(filename))
